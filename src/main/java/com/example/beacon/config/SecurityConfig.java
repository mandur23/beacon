    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/alerts/stream").hasAnyRole("ADMIN", "OPERATOR", "ANALYST", "VIEWER", "USER")
                ...
                .requestMatchers(HttpMethod.POST, "/api/threats/*/whitelist").hasAnyRole("ADMIN", "OPERATOR", "ANALYST")
                .requestMatchers(HttpMethod.POST, "/api/agents/isolate/**").hasAnyRole("ADMIN", "OPERATOR")
